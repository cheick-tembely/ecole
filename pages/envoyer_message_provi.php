...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($db, $sql)) {
        ...
        echo '<script>alert("Message envoyé avec succès."); setTimeout(function(){ window.location.href = "parent_eleve_provi.php"; }, 1000);</script>';
    } else {
    ...
    header("Location: index_provi.php");
}
?>
