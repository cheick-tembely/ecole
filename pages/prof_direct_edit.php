...
?>
            ...
            </div><a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="prof.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Retour </a>
            <div class="card-body">
         
            <form role="form" method="post" action="prof_direct_edit1.php">
