...
$sql = "SELECT id_pointage, pr.nom_professeur,pr.prenom_professeur,  p.date_debut, p.date_fin, c.libelle_classe, m.libelle_matiere, statut  FROM pointage p, professeur pr,matiere m,classe c where p.id_professeur= pr.id_professeur
...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a type="button" class="btn btn-primary bg-gradient-primary" href="pointage_surv_searchfrm.php?action=edit"><i class="fas fa-fw fa-flip-horizontal fa-share"></i> Retour</a>
                
            <div class="card-body">

            <form role="form" method="post" action="pointage_surv_edit1.php">
