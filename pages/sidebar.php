...
<!-- Graphique -->
      ...
      <li class="nav-item">
        <a class="nav-link" href="note_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Notes</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="niveau_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Niveau Enseignement</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="prof_admin.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="message_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Message aux Professeurs</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="message_grouper_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Message Grouper aux Parents d'Elèves</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="classe_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Classe</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="matiere_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Matière</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="attri_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Attribution Des Cours</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="programme_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Programmes</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="fiche_sequence_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Fiche de sequence</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="emploi_du_temp_admin.php">
          <i class="fas fa-clipboard-list"></i>
          <span>Emploi du Temps</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="parent_eleve_admin.php">
          <i class="fas fa-fw fa-users"></i>
