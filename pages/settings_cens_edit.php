...
?>	
        ...
        if ($_SESSION['niveau']=='Administrateur'){  ?>
       ...
       if ($_SESSION['niveau']=='Surveillant'){  ?>
...
if ($_SESSION['niveau']=='Promoteur'){  ?>

    <script type="text/javascript">
       alert("Compte Utilisateur modifiez avec succès.");
       window.location = "index_promo.php";
   </script>
   <?php
