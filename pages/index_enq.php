...
if (isset($_SESSION['nom_user']) && isset($_SESSION['prenom_user'])) {
    ...
    $nomEcole = $row['nom_ecole'];
        ...
        echo '<div class="card-body text-center">';
        echo '<div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Matières</div>';
        echo '<div class="h6 mb-0 font-weight-bold text-gray-800">';
        $query_pointages = "SELECT COUNT(*) FROM matiere WHERE nom_ecole = '$nomEcole'";
        ...
        echo '<div class="card-body text-center">';
        echo '<div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Nbre Utilisateurs</div>';
        echo '<div class="h6 mb-0 font-weight-bold text-gray-800">';
        ...
        echo "$total_utilisateurs Utilisateurs";
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
