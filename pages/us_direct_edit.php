...
$opt .= "</select>";
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            </div><a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="user_direct.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Retour </a>
            <div class="card-body">
      

            <form role="form" method="post" action="us_direct_edit1.php">
