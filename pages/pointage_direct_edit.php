...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a type="button" class="btn btn-primary bg-gradient-primary" href="pointage_direct_searchfrm.php?action=edit"><i class="fas fa-fw fa-flip-horizontal fa-share"></i> Retour</a>
                
            <div class="card-body">

            <form role="form" method="post" action="pointage_direct_edit1.php">
