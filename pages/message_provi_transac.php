...
JOIN niveau t ON t.id_niveau=u.id_niveau WHERE id_user = '.$_SESSION['MEMBER_ID'].'';
          ...
          <div class="col-lg-12">
            <?php
              ...
              (id_message, nom_envoyeur,prenom_envoyeur,poste_envoyeur,nom_destinateur,prenom_destinateur,poste_destinateur,motif,dates)
              VALUES (Null,'$fname','$lname','$ne','$sp','$ns','$ad','$pn','$da')");

            ?>
              <script type="text/javascript">
                window.location = "message_provi.php";
              </script>
          </div>
