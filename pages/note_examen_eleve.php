...
if (isset($_SESSION['nom']) && isset($_SESSION['prenom'])) {
    ...
    // Requête SQL pour récupérer toutes les notes de l'élève connecté
    $sql = "SELECT n.* FROM note_examen n 
            JOIN etudiant e ON n.id_etudiant = e.id_etudiant 
            WHERE e.nom = '$nom' AND e.prenom = '$prenom' AND n.champ_visible = 1";
...
<body>
    <div class="container">
        <h3 class="text-center">Notes d'examen de l'élève : <?php echo $nom . " " . $prenom; ?></h3>
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td><?php echo $row["total_devoir"]; ?></td>
