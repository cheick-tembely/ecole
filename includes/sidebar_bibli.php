...
<!-- Nav Item - Dashboard -->
<li class="nav-item">
    <a class="nav-link" href="index_bibli.php">
...
<li class="nav-item">
    <a class="nav-link" href="verifie_livre.php">
        <i class="mdi mdi-book"></i>
        <span>Etat des Livres</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="modifier_commande.php">
        <i class="mdi mdi-book"></i>
        <span>Commande des Livres des Elèves</span>
    </a>
</li>
<!-- Graphique -->
    ...
    <!-- End of Sidebar -->
    <?php include_once 'topbar_bibli.php'; ?>
