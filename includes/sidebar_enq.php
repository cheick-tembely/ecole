...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index_enq.php">
...
<!-- Nav Item - Dashboard -->
<li class="nav-item">
    <a class="nav-link" href="index_enq.php">
...
<li class="nav-item">
        <a class="nav-link" href="email_enq.php">
            <i class="fas fa-envelope"></i>
            <span>Message aux Administrateur Local</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="niveau_enq.php">
            <i class="fas fa-school"></i>
            <span>Niveau Enseignement/classe</span>
        </a>
        <li class="nav-item">
        <a class="nav-link" href="prof_enq.php">
            <i class="fas fa-chalkboard-teacher"></i>
            <span>Liste Professeur</span>
        </a>
    </li>
