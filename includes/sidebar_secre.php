...
#text{
 ...
 <!-- Favicon-->
 <link rel="icon" type="image/x-icon" href="../pages/ecole-gesy.jpg" />
...
<!-- Graphique -->
    ...
    <li class="nav-item">
      <a class="nav-link" href="prof_secre.php">
        <i class="fas fa-chalkboard-teacher"></i>
        <span>Liste des Professeurs</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="programme_secre.php">
        <i class="fas fa-book-open"></i>
        <span>Programmes</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="matiere_secre.php">
        <i class="fas fa-book-open"></i>
        <span>Matière</span></a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="coefficient_secre.php">
        <i class="fas fa-balance-scale"></i>
        <span>Coefficient/Matière</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="email_secre.php">
    ...
    <li class="nav-item">
      <a class="nav-link" href="search_form.php">
        <i class="fas fa-envelope"></i>
        <span>Localisation des Lieux</span>
      </a>
    </li>
      <!-- Divider -->
