...
<li class="nav-item">
    <a class="nav-link" href="index_eleve.php">
...
<li class="nav-item">
    <a class="nav-link" href="note_examen_eleve.php">
        <i class="fas fa-clipboard-list"></i>
        <span>Notes d'examen</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="devoir_eleve.php">
        <i class="fas fa-clipboard-list"></i>
        <span>Devoir à Domicile</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="profil_eleve.php">
        <i class="fas fa-clipboard-list"></i>
        <span>Profil</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="livre_etudiant.php">
...
<li class="nav-item">
    <a class="nav-link" href="emprunt.php">
        <i class="fas fa-library-books"></i>
        <span>Emprunter des Livres</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="bulletin_eleve.php">
        <i class="fas fa-clipboard-list"></i>
        <span>Bulletin Scolaire</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link" href="transfert_eleve.php">
    ...
    <!-- End of Sidebar -->
    <?php include_once 'topbar_eleve.php'; ?>
